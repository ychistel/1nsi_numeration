...
On donne trois nombres écrits dans des bases différentes:
\begin{itemize}[label=\textbullet]
\item En base 10 : $x=185$
\item En base 2 : $y=10111001$
\item En base 16 : $z=B9$
\end{itemize}

\begin{enumerate}
\item Si la base d'écriture est le nombre $b$, alors les chiffres utilisés pour écrire des nombres sont tous les chiffres de $0$ à $b-1$.

Donner les chiffres utilisés dans les bases 10, 2 et 16.

\item Le nombre $y$  écrit en base 2 est dit binaire. Donner sa valeur écrite dans la base 10.

Que peut-on en déduire sur les nombres $x$ et $y$ ?

\item Le nombre $z$ écrit en base 16 est dit hexadécimal. Donner sa valeur écrite dans la base 10.

Que peut-on en déduire sur les nombres $x$, $y$ et $z$ ?


\item L'écriture du nombre $y$ en base 2 est sur 1 octet (8 bits). On coupe cet octet en 2 quartets de 4 bits. Expliquer le lien qui existe entre les écritures $y$ et $z$. 
\end{enumerate}
